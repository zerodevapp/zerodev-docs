...
The most straightforward way to create a wallet is through the [ZeroKit Widget](/widget/getting-started).  If you are building a DApp (as opposed to a wallet/infra/onramp), the widget is likely what you want to use.
